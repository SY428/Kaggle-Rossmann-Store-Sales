...
# arima(trainStore1$Sales, order = c(0,0,1), seasonal = list(order = c(0,0,1), period = 12))
# # sigma^2 estimated as 667025:  log likelihood = -6345.36,  aic = 12698.72
# 
# # ARIMA(0,0,1)x(0,1,1).12
# arima(trainStore1$Sales, order = c(0,0,1), seasonal = list(order = c(0,1,1), period = 12))
# # sigma^2 estimated as 669336:  log likelihood = -6255.86,  aic = 12517.71
# 
# # ARIMA(5,0,1)x(0,1,1).12
# arima(trainStore1$Sales, order = c(5,0,1), seasonal = list(order = c(0,1,1), period = 12))
# # sigma^2 estimated as 493762:  log likelihood = -6141.17,  aic = 12298.35
# 
# # ARIMA(1,0,0)x(1,0,0).12
# arima(trainStore1$Sales, order = c(1,0,0), seasonal = list(order = c(1,0,0), period = 12))
# # sigma^2 estimated as 523343:  log likelihood = -6250.84,  aic = 12509.68
# 
# # ARIMA(1,0,0)x(1,0,1).12
# arima(trainStore1$Sales, order = c(1,0,0), seasonal = list(order = c(1,0,1), period = 12))
# # sigma^2 estimated as 508762:  log likelihood = -6240.22,  aic = 12490.43
# 
# # ARIMA(1,0,1)x(1,0,0).12
# arima(trainStore1$Sales, order = c(1,0,1), seasonal = list(order = c(1,0,0), period = 12))
# # sigma^2 estimated as 521295:  log likelihood = -6249.34,  aic = 12508.69
# 
# # ARIMA(1,0,1)x(1,0,1).12
# arima(trainStore1$Sales, order = c(1,0,1), seasonal = list(order = c(1,0,1), period = 12))
# # sigma^2 estimated as 506072:  log likelihood = -6238.21,  aic = 12488.42
# 
# # ARIMA(1,1,1)x(1,0,1).12
# arima(trainStore1$Sales, order = c(1,1,1), seasonal = list(order = c(1,0,1), period = 12))
# # sigma^2 estimated as 509410:  log likelihood = -6234.45,  aic = 12478.89
...
# sigma^2 estimated as 352172:  log likelihood=-6090.43 AIC=12204.87   AICc=12205.27   BIC=12260.79
...
# "Best ARIMA Model: (1,0,5),(2,1,3)"
# "Minimum AIC: 12013.3745973688"
...
# Arima(trainStore1$Sales, order = c(1,1,5), seasonal = list(order = c(2,0,2), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(1,1,5), seasonal = list(order = c(2,0,3), period = 12), xreg = xreg1)
...
# Error in
# Arima(trainStore1$Sales, order = c(1,1,5), seasonal = list(order = c(3,1,1), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(1,1,5), seasonal = list(order = c(3,1,2), period = 12), xreg = xreg1)
...
# "Minimum AIC: 12002.5189894768"
# "Best ARIMA Model: (2,1,5),(2,1,3)"

# Error in
# Arima(trainStore1$Sales, order = c(3,0,0), seasonal = list(order = c(3,0,0), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(3,0,0), seasonal = list(order = c(3,0,2), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(3,0,0), seasonal = list(order = c(3,0,3), period = 12), xreg = xreg1)

for (i in 3:3) { for (j in 0:0) { for (k in 0:0) {
...
for (i in 3:3) { for (j in 0:0) { for (k in 1:5) {
  for (l in 0:3) { for (m in 0:1) { for(n in 0:3) {
    print(paste("Currently Working On: ", "(", i, ",", j, ",", k, "),(", l, ",", m, ",", n, ")", sep = ""))
    myARIMA.temp <- Arima(trainStore1$Sales, order = c(i,j,k), seasonal = list(order = c(l,m,n), period = 12), xreg = xreg1)
    if(minAIC > myARIMA.temp$aic) {
...
# Error in
# Arima(trainStore1$Sales, order = c(3,0,1), seasonal = list(order = c(3,0,1), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(3,0,1), seasonal = list(order = c(3,0,2), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(3,0,1), seasonal = list(order = c(3,0,3), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(3,0,1), seasonal = list(order = c(3,1,0), period = 12), xreg = xreg1)
...
# Error in
# Arima(trainStore1$Sales, order = c(3,0,2), seasonal = list(order = c(3,1,3), period = 12), xreg = xreg1)
...
# Error in
# Arima(trainStore1$Sales, order = c(3,0,4), seasonal = list(order = c(1,1,2), period = 12), xreg = xreg1)
...
# Error in
# Arima(trainStore1$Sales, order = c(3,0,4), seasonal = list(order = c(2,1,3), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(3,0,4), seasonal = list(order = c(3,0,0), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(3,0,4), seasonal = list(order = c(3,0,1), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(3,0,4), seasonal = list(order = c(3,0,2), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(3,0,4), seasonal = list(order = c(3,0,3), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(3,0,4), seasonal = list(order = c(3,1,0), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(3,0,4), seasonal = list(order = c(3,1,1), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(3,0,4), seasonal = list(order = c(3,1,2), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(3,0,4), seasonal = list(order = c(3,1,3), period = 12), xreg = xreg1)
...
# Error in
# Arima(trainStore1$Sales, order = c(3,0,5), seasonal = list(order = c(1,0,2), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(3,0,5), seasonal = list(order = c(1,0,3), period = 12), xreg = xreg1)
...
# Error in
# Arima(trainStore1$Sales, order = c(3,0,5), seasonal = list(order = c(2,0,2), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(3,0,5), seasonal = list(order = c(2,0,3), period = 12), xreg = xreg1)
...
# Error in
# Arima(trainStore1$Sales, order = c(3,0,5), seasonal = list(order = c(2,1,3), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(3,0,5), seasonal = list(order = c(3,0,0), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(3,0,5), seasonal = list(order = c(3,0,1), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(3,0,5), seasonal = list(order = c(3,0,3), period = 12), xreg = xreg1)
...
# Error in
# Arima(trainStore1$Sales, order = c(3,0,5), seasonal = list(order = c(3,1,1), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(3,0,5), seasonal = list(order = c(3,1,2), period = 12), xreg = xreg1)
...
# Arima(trainStore1$Sales, order = c(3,1,5), seasonal = list(order = c(1,0,1), period = 12), xreg = xreg1)

for (i in 3:3) { for (j in 1:1) { for (k in 5:5) {
  for (l in 1:1) { for (m in 0:0) { for(n in 2:3) {
    print(paste("Currently Working On: ", "(", i, ",", j, ",", k, "),(", l, ",", m, ",", n, ")", sep = ""))
    myARIMA.temp <- Arima(trainStore1$Sales, order = c(i,j,k), seasonal = list(order = c(l,m,n), period = 12), xreg = xreg1)
    if(minAIC > myARIMA.temp$aic) {
      print(paste("Minimum AIC: ", myARIMA.temp$aic, sep = ""))
...
# Arima(trainStore1$Sales, order = c(3,1,5), seasonal = list(order = c(1,1,1), period = 12), xreg = xreg1)

for (i in 3:3) { for (j in 1:1) { for (k in 5:5) {
  for (l in 1:1) { for (m in 1:1) { for(n in 2:3) {
    print(paste("Currently Working On: ", "(", i, ",", j, ",", k, "),(", l, ",", m, ",", n, ")", sep = ""))
    myARIMA.temp <- Arima(trainStore1$Sales, order = c(i,j,k), seasonal = list(order = c(l,m,n), period = 12), xreg = xreg1)
    if(minAIC > myARIMA.temp$aic) {
      print(paste("Minimum AIC: ", myARIMA.temp$aic, sep = ""))
...
# Arima(trainStore1$Sales, order = c(3,1,5), seasonal = list(order = c(2,0,1), period = 12), xreg = xreg1)
for (i in 3:3) { for (j in 1:1) { for (k in 5:5) {
  for (l in 2:2) { for (m in 0:0) { for(n in 2:3) {
    print(paste("Currently Working On: ", "(", i, ",", j, ",", k, "),(", l, ",", m, ",", n, ")", sep = ""))
    myARIMA.temp <- Arima(trainStore1$Sales, order = c(i,j,k), seasonal = list(order = c(l,m,n), period = 12), xreg = xreg1)
    if(minAIC > myARIMA.temp$aic) {
      print(paste("Minimum AIC: ", myARIMA.temp$aic, sep = ""))
...
# Arima(trainStore1$Sales, order = c(3,1,5), seasonal = list(order = c(2,1,0), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(3,1,5), seasonal = list(order = c(2,1,1), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(3,1,5), seasonal = list(order = c(2,1,2), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(3,1,5), seasonal = list(order = c(2,1,3), period = 12), xreg = xreg1)
...
# Arima(trainStore1$Sales, order = c(3,1,5), seasonal = list(order = c(3,0,0), period = 12), xreg = xreg1)
...
# Arima(trainStore1$Sales, order = c(3,1,5), seasonal = list(order = c(3,1,0), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(3,1,5), seasonal = list(order = c(3,1,1), period = 12), xreg = xreg1)
...
# Arima(trainStore1$Sales, order = c(4,0,4), seasonal = list(order = c(1,0,1), period = 12), xreg = xreg1)

for (i in 4:4) { for (j in 0:0) { for (k in 4:4) {
  for (l in 1:1) { for (m in 0:0) { for(n in 2:3) {
    print(paste("Currently Working On: ", "(", i, ",", j, ",", k, "),(", l, ",", m, ",", n, ")", sep = ""))
    myARIMA.temp <- Arima(trainStore1$Sales, order = c(i,j,k), seasonal = list(order = c(l,m,n), period = 12), xreg = xreg1)
    if(minAIC > myARIMA.temp$aic) {
...
# Arima(trainStore1$Sales, order = c(4,0,4), seasonal = list(order = c(2,0,1), period = 12), xreg = xreg1)
...
# Arima(trainStore1$Sales, order = c(4,0,4), seasonal = list(order = c(3,0,3), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(4,0,4), seasonal = list(order = c(3,1,0), period = 12), xreg = xreg1)

for (i in 4:4) { for (j in 0:0) { for (k in 4:4) {
  for (l in 3:3) { for (m in 1:1) { for(n in 1:3) {
    print(paste("Currently Working On: ", "(", i, ",", j, ",", k, "),(", l, ",", m, ",", n, ")", sep = ""))
    myARIMA.temp <- Arima(trainStore1$Sales, order = c(i,j,k), seasonal = list(order = c(l,m,n), period = 12), xreg = xreg1)
    if(minAIC > myARIMA.temp$aic) {
      print(paste("Minimum AIC: ", myARIMA.temp$aic, sep = ""))
...
for (i in 4:4) { for (j in 0:0) { for (k in 5:5) {
  for (l in 0:3) { for (m in 0:1) { for(n in 0:3) {
    print(paste("Currently Working On: ", "(", i, ",", j, ",", k, "),(", l, ",", m, ",", n, ")", sep = ""))
    myARIMA.temp <- Arima(trainStore1$Sales, order = c(i,j,k), seasonal = list(order = c(l,m,n), period = 12), xreg = xreg1)
    if(minAIC > myARIMA.temp$aic) {
...
# Arima(trainStore1$Sales, order = c(4,0,5), seasonal = list(order = c(1,1,3), period = 12), xreg = xreg1)
...
# Arima(trainStore1$Sales, order = c(4,0,5), seasonal = list(order = c(2,1,3), period = 12), xreg = xreg1)
...
# Arima(trainStore1$Sales, order = c(4,0,5), seasonal = list(order = c(3,0,1), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(4,0,5), seasonal = list(order = c(3,0,2), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(4,0,5), seasonal = list(order = c(3,0,3), period = 12), xreg = xreg1)
# Arima(trainStore1$Sales, order = c(4,0,5), seasonal = list(order = c(3,1,0), period = 12), xreg = xreg1)
...
for (i in 4:4) { for (j in 1:1) { for (k in 0:5) {
  for (l in 0:3) { for (m in 0:1) { for(n in 0:3) {
    print(paste("Currently Working On: ", "(", i, ",", j, ",", k, "),(", l, ",", m, ",", n, ")", sep = ""))
    myARIMA.temp <- Arima(trainStore1$Sales, order = c(i,j,k), seasonal = list(order = c(l,m,n), period = 12), xreg = xreg1)
    if(minAIC > myARIMA.temp$aic) {
...
# Arima(trainStore1$Sales, order = c(4,1,5), seasonal = list(order = c(3,0,3), period = 12), xreg = xreg1)

for (i in 4:4) { for (j in 1:1) { for (k in 0:0) {
  for (l in 3:3) { for (m in 1:1) { for(n in 0:3) {
    print(paste("Currently Working On: ", "(", i, ",", j, ",", k, "),(", l, ",", m, ",", n, ")", sep = ""))
    myARIMA.temp <- Arima(trainStore1$Sales, order = c(i,j,k), seasonal = list(order = c(l,m,n), period = 12), xreg = xreg1)
    if(minAIC > myARIMA.temp$aic) {
...
for (i in 4:4) { for (j in 1:1) { for (k in 1:5) {
  for (l in 0:3) { for (m in 0:1) { for(n in 0:3) {
    print(paste("Currently Working On: ", "(", i, ",", j, ",", k, "),(", l, ",", m, ",", n, ")", sep = ""))
    myARIMA.temp <- Arima(trainStore1$Sales, order = c(i,j,k), seasonal = list(order = c(l,m,n), period = 12), xreg = xreg1)
    if(minAIC > myARIMA.temp$aic) {
...
for (i in 4:4) { for (j in 1:1) { for (k in 2:2) {
  for (l in 0:0) { for (m in 0:0) { for(n in 1:3) {
    print(paste("Currently Working On: ", "(", i, ",", j, ",", k, "),(", l, ",", m, ",", n, ")", sep = ""))
    myARIMA.temp <- Arima(trainStore1$Sales, order = c(i,j,k), seasonal = list(order = c(l,m,n), period = 12), xreg = xreg1)
    if(minAIC > myARIMA.temp$aic) {
      print(paste("Minimum AIC: ", myARIMA.temp$aic, sep = ""))
...
for (i in 4:4) { for (j in 1:1) { for (k in 2:2) {
  for (l in 0:0) { for (m in 1:1) { for(n in 0:3) {
    print(paste("Currently Working On: ", "(", i, ",", j, ",", k, "),(", l, ",", m, ",", n, ")", sep = ""))
    myARIMA.temp <- Arima(trainStore1$Sales, order = c(i,j,k), seasonal = list(order = c(l,m,n), period = 12), xreg = xreg1)
    if(minAIC > myARIMA.temp$aic) {
      print(paste("Minimum AIC: ", myARIMA.temp$aic, sep = ""))
...
for (i in 4:4) { for (j in 1:1) { for (k in 3:5) {
  for (l in 0:3) { for (m in 0:1) { for(n in 0:3) {
    print(paste("Currently Working On: ", "(", i, ",", j, ",", k, "),(", l, ",", m, ",", n, ")", sep = ""))
    myARIMA.temp <- Arima(trainStore1$Sales, order = c(i,j,k), seasonal = list(order = c(l,m,n), period = 12), xreg = xreg1)
    if(minAIC > myARIMA.temp$aic) {
...
for (i in 5:5) { for (j in 0:0) { for (k in 2:5) {
  for (l in 0:3) { for (m in 0:1) { for(n in 0:3) {
    print(paste("Currently Working On: ", "(", i, ",", j, ",", k, "),(", l, ",", m, ",", n, ")", sep = ""))
    myARIMA.temp <- Arima(trainStore1$Sales, order = c(i,j,k), seasonal = list(order = c(l,m,n), period = 12), xreg = xreg1)
    if(minAIC > myARIMA.temp$aic) {
...
for (i in 5:5) { for (j in 0:0) { for (k in 2:2) {
  for (l in 2:2) { for (m in 0:0) { for(n in 3:3) {
    print(paste("Currently Working On: ", "(", i, ",", j, ",", k, "),(", l, ",", m, ",", n, ")", sep = ""))
    myARIMA.temp <- Arima(trainStore1$Sales, order = c(i,j,k), seasonal = list(order = c(l,m,n), period = 12), xreg = xreg1)
    if(minAIC > myARIMA.temp$aic) {
      print(paste("Minimum AIC: ", myARIMA.temp$aic, sep = ""))
...
for (i in 6:6) { for (j in 0:1) { for (k in 0:5) {
  for (l in 0:3) { for (m in 0:1) { for(n in 0:3) {
    print(paste("Currently Working On: ", "(", i, ",", j, ",", k, "),(", l, ",", m, ",", n, ")", sep = ""))
    myARIMA.temp <- Arima(trainStore1$Sales, order = c(i,j,k), seasonal = list(order = c(l,m,n), period = 12), xreg = xreg1)
    if(minAIC > myARIMA.temp$aic) {
...
# "Minimum AIC: 10741.1091471929"
# "Best ARIMA Model: (1,1,2),(0,1,1)"
myARIMA.min
...
newxreg1 <- model.matrix(~ droplevels(as.factor(testStore1$DayOfWeek)) 
                         # + testStore1$Customers
                         + testStore1$Promo
                         + testStore1$SchoolHoliday)
newxreg1 <- newxreg1[,-1]
colnames(newxreg1) <- c("Mon", "Sat", "Thur", "Tues", "Wed", "Customers", "Promo", "SchoolHoliday")


myARIMA.112x011.12 <- myARIMA.min
trainSamplePred <- predict(myARIMA.112x011.12, newxreg = , n.ahead = length(pred.date))
plot2013_range <- ggplot(data = subset(trainStore1, (trainStore1$Date >= as.Date("2013-08-01")) & (trainStore1$Date < as.Date("2013-09-18"))), aes(Date, Sales)) + geom_line()
plot2014_range <- ggplot(data = subset(trainStore1, (trainStore1$Date >= as.Date("2014-08-01")) & (trainStore1$Date < as.Date("2014-09-18"))), aes(Date, Sales)) + geom_line()
plot2015_range <- ggplot(data = data.frame(Date = as.Date(pred.date), Sales = trainSamplePred$pred), aes(x = Date, y = Sales)) + geom_line()
grid.arrange(plot2013_range, plot2014_range, plot2015_range, nrow = 3)
